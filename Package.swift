  ...
  targets: [
    ...
    .target(
      ...
      exclude: [
        ...
        "internal/socket_abstraction/base_socket_test.cc",
        "internal/socket_abstraction/message_write_request_test.cc",
        "internal/socket_abstraction/mock_socket.cc",
        "internal/socket_abstraction/packet_test.cc",
        "internal/socket_abstraction/packetizer_test.cc",
        "internal/socket_abstraction/single_packet_write_request_test.cc",
        "internal/socket_abstraction/v0/client_server_functional_test.cc",
        "internal/socket_abstraction/v1/client_socket_test.cc",
        "internal/socket_abstraction/v1/server_socket_test.cc",
        // simulation
