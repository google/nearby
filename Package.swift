  ...
  targets: [
    ...
    .target(
      ...
      exclude: [
        ...
        "jsoncpp/CONTRIBUTING.md",
        "jsoncpp/CTestConfig.cmake",
        "jsoncpp/LICENSE",
        "jsoncpp/README.md",
        "jsoncpp/CITATION.cff",
        "jsoncpp/amalgamate.py",
        "jsoncpp/appveyor.yml",
        "jsoncpp/dev.makefile",
        "jsoncpp/doxybuild.py",
        "jsoncpp/get_version.pl",
        "jsoncpp/jsoncpp-namespaced-targets.cmake",
      ...
      sources: ["EmptySwiftPackageManagerFile.cc"],
      publicHeadersPath: "jsoncpp/include"
    ),
    .target(
      name: "protobuf",
