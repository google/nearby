...
BooleanMediumSelector BasePcpHandler::ComputeIntersectionOfSupportedMediums(
  ...
  // Not using designated initializer since according to C++20 only aggregate
  // classes may be initialized with designated initializers, and the Visual
  // Studio c compiler errors on them.
...
Status BasePcpHandler::RequestConnection(ClientProxy* client,
  ...
  RunOnPcpHandlerThread(
      "request-connection", [this, client, &info, options, endpoint_id,
        ...
        // Not using designated initializer since according to C++20 only
        // aggregate classes may be initialized with designated initializers,
        //  and the Visual Studio c compiler errors on them.
