...
Payload::Payload(Payload&& other) = default;
Payload::~Payload() = default;
Payload& Payload::operator=(Payload&& other) = default;
...
Id Payload::GetId() const { return id_; }
...
Id Payload::GenerateId() { return Prng().NextInt64(); }
