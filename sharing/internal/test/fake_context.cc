...
#include "third_party/nearby/sharing/internal/test/fake_context.h"
...
#include "third_party/nearby/sharing/internal/api/bluetooth_adapter.h"
#include "third_party/nearby/sharing/internal/api/fast_initiation_manager.h"
#include "third_party/nearby/sharing/internal/api/shell.h"
#include "third_party/nearby/sharing/internal/api/wifi_adapter.h"
#include "third_party/nearby/sharing/internal/public/connectivity_manager.h"
#include "third_party/nearby/sharing/internal/test/fake_bluetooth_adapter.h"
#include "third_party/nearby/sharing/internal/test/fake_connectivity_manager.h"
#include "third_party/nearby/sharing/internal/test/fake_fast_initiation_manager.h"
#include "third_party/nearby/sharing/internal/test/fake_shell.h"
#include "third_party/nearby/sharing/internal/test/fake_wifi_adapter.h"
...
FakeContext::FakeContext()
    : fake_clock_(std::make_unique<FakeClock>()),
      ...
      data_manager_(std::make_unique<data::DataManager>(
          data::DataManager::DataStorageType::kMemory)),
...
data::DataManager* FakeContext::GetDataManager() const {
