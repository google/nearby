...
public:
  ...
  explicit PROTOBUF_CONSTEXPR PrivateCredential_ConsumedSaltsEntry_DoNotUse(
...
class PrivateCredential final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR PrivateCredential(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const PrivateCredential& from) {
    PrivateCredential::MergeImpl(*this, from);
  }
  private:
...
class PublicCredential final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR PublicCredential(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const PublicCredential& from) {
    PublicCredential::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void PrivateCredential::set_secret_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.secret_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PrivateCredential::release_secret_id() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.secret_id_.Release();
...
void PrivateCredential::set_authenticity_key(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.authenticity_key_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PrivateCredential::release_authenticity_key() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.authenticity_key_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void PrivateCredential::set_allocated_authenticity_key(std::string* authenticity_key) {
  ...
  _impl_.authenticity_key_.SetAllocated(authenticity_key, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.authenticity_key_.IsDefault()) {
    _impl_.authenticity_key_.Set("", GetArenaForAllocation());
  }
...
inline void PrivateCredential::clear_start_time_millis() {
  _impl_.start_time_millis_ = uint64_t{0u};
...
inline void PrivateCredential::clear_end_time_millis() {
  _impl_.end_time_millis_ = uint64_t{0u};
...
void PrivateCredential::set_metadata_encryption_key(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.metadata_encryption_key_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PrivateCredential::release_metadata_encryption_key() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.metadata_encryption_key_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void PrivateCredential::set_allocated_metadata_encryption_key(std::string* metadata_encryption_key) {
  ...
  _impl_.metadata_encryption_key_.SetAllocated(metadata_encryption_key, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.metadata_encryption_key_.IsDefault()) {
    _impl_.metadata_encryption_key_.Set("", GetArenaForAllocation());
  }
...
inline const ::nearby::internal::DeviceMetadata& PrivateCredential::_internal_device_metadata() const {
  const ::nearby::internal::DeviceMetadata* p = _impl_.device_metadata_;
...
inline void PrivateCredential::unsafe_arena_set_allocated_device_metadata(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.device_metadata_);
  }
  _impl_.device_metadata_ = device_metadata;
  if (device_metadata) {
...
inline ::nearby::internal::DeviceMetadata* PrivateCredential::release_device_metadata() {
  _impl_._has_bits_[0] &= ~0x00000010u;
  ::nearby::internal::DeviceMetadata* temp = _impl_.device_metadata_;
...
void PublicCredential::set_encrypted_metadata_bytes(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.encrypted_metadata_bytes_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PublicCredential::release_encrypted_metadata_bytes() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.encrypted_metadata_bytes_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void PublicCredential::set_allocated_encrypted_metadata_bytes(std::string* encrypted_metadata_bytes) {
  ...
  _impl_.encrypted_metadata_bytes_.SetAllocated(encrypted_metadata_bytes, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.encrypted_metadata_bytes_.IsDefault()) {
    _impl_.encrypted_metadata_bytes_.Set("", GetArenaForAllocation());
  }
...
void PublicCredential::set_metadata_encryption_key_tag(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000010u;
 _impl_.metadata_encryption_key_tag_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PublicCredential::release_metadata_encryption_key_tag() {
  ...
  _impl_._has_bits_[0] &= ~0x00000010u;
  auto* p = _impl_.metadata_encryption_key_tag_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void PublicCredential::set_allocated_metadata_encryption_key_tag(std::string* metadata_encryption_key_tag) {
  ...
  _impl_.metadata_encryption_key_tag_.SetAllocated(metadata_encryption_key_tag, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.metadata_encryption_key_tag_.IsDefault()) {
    _impl_.metadata_encryption_key_tag_.Set("", GetArenaForAllocation());
  }
