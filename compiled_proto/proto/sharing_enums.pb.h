...
constexpr EventType EventType_MAX = CLOUD_SHARING_RPC_RESULT;
...
constexpr SyncPurpose SyncPurpose_MAX = SYNC_EXHAUST_SALT;
...
enum ScanType : int {
  UNKNOWN_SCAN_TYPE = 0,
  FOREGROUND_SCAN = 1,
  FOREGROUND_RETRY_SCAN PROTOBUF_DEPRECATED_ENUM = 2,
  DIRECT_SHARE_SCAN = 3,
  BACKGROUND_SCAN = 4
};
...
constexpr AdvertisingMode AdvertisingMode_MAX = SUSPENDED_ADVERTISING_MODE;
...
constexpr DiscoveryMode DiscoveryMode_MAX = SUSPENDED_DISCOVERY_MODE;
...
constexpr CloudCreateSharingResult CloudCreateSharingResult_MIN = CLOUD_CREATE_SHARING_RESULT_UNKNOWN;
constexpr CloudCreateSharingResult CloudCreateSharingResult_MAX = CLOUD_CREATE_SHARING_RESULT_FILE_LIMIT_EXCEED_SIZE;
constexpr int CloudCreateSharingResult_ARRAYSIZE = CloudCreateSharingResult_MAX + 1;

const std::string& CloudCreateSharingResult_Name(CloudCreateSharingResult value);
template<typename T>
inline const std::string& CloudCreateSharingResult_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CloudCreateSharingResult>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CloudCreateSharingResult_Name.");
  return CloudCreateSharingResult_Name(static_cast<CloudCreateSharingResult>(enum_t_value));
}
...
constexpr CloudRegisterReceiverResult CloudRegisterReceiverResult_MIN = CLOUD_REGISTER_RECEIVER_RESULT_UNKNOWN;
constexpr CloudRegisterReceiverResult CloudRegisterReceiverResult_MAX = CLOUD_REGISTER_RECEIVER_RESULT_DATA_LOSS;
constexpr int CloudRegisterReceiverResult_ARRAYSIZE = CloudRegisterReceiverResult_MAX + 1;

const std::string& CloudRegisterReceiverResult_Name(CloudRegisterReceiverResult value);
template<typename T>
inline const std::string& CloudRegisterReceiverResult_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CloudRegisterReceiverResult>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CloudRegisterReceiverResult_Name.");
  return CloudRegisterReceiverResult_Name(static_cast<CloudRegisterReceiverResult>(enum_t_value));
}
...
constexpr CloudActionType CloudActionType_MIN = CLOUD_ACTION_TYPE_UNKNOWN;
constexpr CloudActionType CloudActionType_MAX = CLOUD_ACTION_TYPE_RETRY;
constexpr int CloudActionType_ARRAYSIZE = CloudActionType_MAX + 1;

const std::string& CloudActionType_Name(CloudActionType value);
template<typename T>
inline const std::string& CloudActionType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CloudActionType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CloudActionType_Name.");
  return CloudActionType_Name(static_cast<CloudActionType>(enum_t_value));
}
...
template <> struct is_proto_enum< ::location::nearby::proto::sharing::CloudCreateSharingResult> : ::std::true_type {};
template <> struct is_proto_enum< ::location::nearby::proto::sharing::CloudRegisterReceiverResult> : ::std::true_type {};
template <> struct is_proto_enum< ::location::nearby::proto::sharing::CloudActionType> : ::std::true_type {};
