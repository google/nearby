...
#ifndef THIRD_PARTY_NEARBY_INTERNAL_SOCKET_ABSTRACTION_WRITE_REQUEST_H_
#define THIRD_PARTY_NEARBY_INTERNAL_SOCKET_ABSTRACTION_WRITE_REQUEST_H_
...
#endif  // THIRD_PARTY_NEARBY_INTERNAL_SOCKET_ABSTRACTION_WRITE_REQUEST_H_
