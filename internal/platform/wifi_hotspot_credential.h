...
class HotspotCredentials {
 public:
  ...
  // Returns the password to connect to the hotspot
 ...
 private:
  // Windows WINRT WiFiDirect API needs user to create SSID/Password pair to
  // start a legacy hotspot. Other OS may create SSID/Password by itself.
  std::string ssid_;
