...
class WifiHotspotServerSocket final {
 public:
  ...
  bool IsValid() const { return impl_ != nullptr; }
  api::WifiHotspotServerSocket& GetImpl() { return *impl_; }
...
class WifiHotspotMedium {
 public:
  ...
  WifiHotspotSocket ConnectToService(const std::string& ip_address, int port,
  ...
  api::WifiHotspotMedium& GetImpl() { return *impl_; }
