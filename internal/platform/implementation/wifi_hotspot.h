...
class WifiHotspotMedium {
 public:
  ...
  // Start WIFI Hotspot with specific Crendentials
  virtual bool StartWifiHotspot(HotspotCredentials* hotspot_credentials_) = 0;

  // Stop WIFI Hotspot
  virtual bool StopWifiHotspot() = 0;

  // Join WIFI Hotspot
  virtual bool ConnectWifiHotspot(HotspotCredentials* hotspot_credentials_) = 0;
