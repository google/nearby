...
#ifndef THIRD_PARTY_NEARBY_INTERNAL_PLATFORM_IMPLEMENTATION_AWDL_H_
#define THIRD_PARTY_NEARBY_INTERNAL_PLATFORM_IMPLEMENTATION_AWDL_H_
...
class AwdlMedium {
 public:
  ...
  // virtual void SetIncludePeerToPeerForApplePlatform(
  //     bool include_peer_to_peer) = 0;
...
#endif  // THIRD_PARTY_NEARBY_INTERNAL_PLATFORM_IMPLEMENTATION_AWDL_H_
