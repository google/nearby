...
#ifndef PLATFORM_IMPL_ANDROID_CONDITION_VARIABLE_H_
#define PLATFORM_IMPL_ANDROID_CONDITION_VARIABLE_H_
...
class ConditionVariable : public api::ConditionVariable {
 public:
  explicit ConditionVariable(android::Mutex* mutex) : mutex_(&mutex->mutex_) {}
...
#endif  // PLATFORM_IMPL_ANDROID_CONDITION_VARIABLE_H_
