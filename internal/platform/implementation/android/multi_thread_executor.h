...
#ifndef PLATFORM_IMPL_ANDROID_MULTI_THREAD_EXECUTOR_H_
#define PLATFORM_IMPL_ANDROID_MULTI_THREAD_EXECUTOR_H_
...
#endif  // PLATFORM_IMPL_ANDROID_MULTI_THREAD_EXECUTOR_H_
