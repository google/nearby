...
#ifndef PLATFORM_IMPL_ANDROID_DEVICE_INFO_H_
#define PLATFORM_IMPL_ANDROID_DEVICE_INFO_H_
...
class DeviceInfo : public api::DeviceInfo {
 public:
  ...
  api::DeviceInfo::OsType GetOsType() const override {
    return api::DeviceInfo::OsType::kAndroid;
  }
...
#endif  // PLATFORM_IMPL_ANDROID_DEVICE_INFO_H_
