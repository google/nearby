...
#ifndef PLATFORM_IMPLEMENTATION_ANDROID_PREFERENCES_REPOSITORY_H_
#define PLATFORM_IMPLEMENTATION_ANDROID_PREFERENCES_REPOSITORY_H_
...
#endif  // PLATFORM_IMPLEMENTATION_ANDROID_PREFERENCES_REPOSITORY_H_
