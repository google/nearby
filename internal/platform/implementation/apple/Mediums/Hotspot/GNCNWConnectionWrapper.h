...
/**
 * The default implementation of GNCNWConnectionWrapping that calls the real Network.framework C
 * functions.
 */
@interface GNCNWConnectionWrapper : NSObject <GNCNWConnectionWrapping>
