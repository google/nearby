...
@property(nonatomic, strong) CBMutableCharacteristic *lastCharacteristicUpdated;
@property(nonatomic, strong) NSData *lastValueUpdated;
@property(nonatomic, strong) NSArray<CBCentral *> *lastCentralsUpdated;
