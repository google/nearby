...
#import "internal/platform/implementation/apple/Mediums/BLE/Sockets/Tests/Fakes/GNSFakeCentralManager.h"
...
- (NSMethodSignature *)methodSignatureForSelector:(SEL)sel {
  return [GNSCentralManager instanceMethodSignatureForSelector:sel];
}
