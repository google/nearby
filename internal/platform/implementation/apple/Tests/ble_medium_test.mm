...
- (void)testStartAdvertising_Success {
  nearby::api::ble_v2::BleAdvertisementData advertising_data;
...
- (void)testStartAdvertisingAsync_Success {
  ...
  nearby::api::ble_v2::BleMedium::AdvertisingCallback callback = {
...
- (void)testStartScanning_Success {
  ...
  nearby::api::ble_v2::TxPowerLevel tx_power_level = nearby::api::ble_v2::TxPowerLevel::kUltraLow;

  auto session = _medium->StartScanning(service_uuid, tx_power_level,
                                        nearby::api::ble_v2::BleMedium::ScanningCallback{});
...
- (void)testConnectToGattServer_PeripheralNotFound {
  auto gatt_client =
      _medium->ConnectToGattServer(99999, nearby::api::ble_v2::TxPowerLevel::kUltraLow, {});
...
- (void)testConnectToGattServer_Success {
  ...
  nearby::api::ble_v2::BleMedium::ScanCallback callback = {
      .advertisement_found_cb = std::function<void(nearby::api::ble_v2::BlePeripheral::UniqueId,
                                                   nearby::api::ble_v2::BleAdvertisementData)>(
          [expectation](nearby::api::ble_v2::BlePeripheral::UniqueId peripheral_id,
                        const nearby::api::ble_v2::BleAdvertisementData &advertisement) {
            [expectation fulfill];
          })};
  _medium->StartScanning(nearby::Uuid(0, 0), nearby::api::ble_v2::TxPowerLevel::kUltraLow,
                         std::move(callback));
  ...
  auto gatt_client = _medium->ConnectToGattServer(fakePeripheral.identifier.hash,
                                                  nearby::api::ble_v2::TxPowerLevel::kUltraLow, {});
...
- (void)testConnectOverL2cap_NotFound {
  auto l2cap_socket = _medium->ConnectOverL2cap(
      123, kTestServiceID, nearby::api::ble_v2::TxPowerLevel::kUltraLow, 99999, nullptr);
...
- (void)testRetrieveBlePeripheralIdFromNativeId {
  ...
  std::optional<nearby::api::ble_v2::BlePeripheral::UniqueId> result1 =
  ...
  std::optional<nearby::api::ble_v2::BlePeripheral::UniqueId> result2 =
  ...
  std::optional<nearby::api::ble_v2::BlePeripheral::UniqueId> result3 =
...
- (void)testHandleAdvertisementFound_KnownPeripheral_NewData {
  ...
  nearby::api::ble_v2::BleMedium::ScanCallback callback1 = {
      .advertisement_found_cb = std::function<void(nearby::api::ble_v2::BlePeripheral::UniqueId,
                                                   nearby::api::ble_v2::BleAdvertisementData)>(
          ^(nearby::api::ble_v2::BlePeripheral::UniqueId peripheral_id,
            const nearby::api::ble_v2::BleAdvertisementData &advertisement) {
  ...
  nearby::api::ble_v2::BleMedium::ScanCallback callback2 = {
      .advertisement_found_cb = std::function<void(nearby::api::ble_v2::BlePeripheral::UniqueId,
                                                   nearby::api::ble_v2::BleAdvertisementData)>(
          ^(nearby::api::ble_v2::BlePeripheral::UniqueId peripheral_id,
            const nearby::api::ble_v2::BleAdvertisementData &advertisement) {
