...
- (void)testSendRequest_Success {
  ...
  [GNCFakeURLProtocol setFakeResponseData:[NSData dataWithBytes:responseBody.c_str() length:responseBody.length()]];
...
- (void)testGetCurrentOS {
  XCTAssertEqual(nearby::api::ImplementationPlatform::GetCurrentOS(),
                 nearby::api::OSName::kApple);
}
...
- (void)testCreateMutex {
  auto mutex =
      nearby::api::ImplementationPlatform::CreateMutex(nearby::api::Mutex::Mode::kRegular);
...
- (void)testCreateOutputFile {
  ...
  auto output_file =
      nearby::api::ImplementationPlatform::CreateOutputFile(path.UTF8String);
...
- (void)testCreateWifiHotspotMedium {
  auto wifi_hotspot_medium =
      nearby::api::ImplementationPlatform::CreateWifiHotspotMedium();
...
- (void)testCreatePreferencesManager {
  auto preferences_manager =
      nearby::api::ImplementationPlatform::CreatePreferencesManager("test");
...
- (void)testCreateWifiDirectMedium {
  auto wifi_direct_medium =
      nearby::api::ImplementationPlatform::CreateWifiDirectMedium();
