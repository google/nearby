...
#include "internal/platform/implementation/apple/Mediums/WiFiCommon/GNCIPv4Address.h"
#include "internal/platform/implementation/apple/Mediums/WiFiCommon/Tests/GNCFakeNWFramework.h"
...
- (void)testConnectToServiceByName {
  ...
  id socket = nearby::apple::network_utils::ConnectToService(_fakeNWFramework, serviceInfo, &flag);
...
- (void)testConnectToServiceByIP {
  nearby::CancellationFlag flag;
  char ip[] = {127, 0, 0, 1};
  std::string ip_address(ip, 4);

  id socket = nearby::apple::network_utils::ConnectToService(_fakeNWFramework, ip_address, 1234,
                                                             YES, &flag);
...
- (void)testListenForService {
  id serverSocket = nearby::apple::network_utils::ListenForService(_fakeNWFramework, 1234, YES);
