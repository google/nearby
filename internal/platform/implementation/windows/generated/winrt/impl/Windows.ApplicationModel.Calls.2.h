...
{
  struct WINRT_IMPL_EMPTY_BASES AcceptedVoipPhoneCallOptions
      : winrt::Windows::ApplicationModel::Calls::IAcceptedVoipPhoneCallOptions {
    AcceptedVoipPhoneCallOptions(std::nullptr_t) noexcept {}
    AcceptedVoipPhoneCallOptions(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Calls::
              IAcceptedVoipPhoneCallOptions(ptr, take_ownership_from_abi) {}
    AcceptedVoipPhoneCallOptions();
    explicit AcceptedVoipPhoneCallOptions(
        param::iterable<hstring> const& associatedDeviceIds);
  };
  struct WINRT_IMPL_EMPTY_BASES AppInitiatedVoipPhoneCallOptions
      : winrt::Windows::ApplicationModel::Calls::
            IAppInitiatedVoipPhoneCallOptions {
    AppInitiatedVoipPhoneCallOptions(std::nullptr_t) noexcept {}
    AppInitiatedVoipPhoneCallOptions(void* ptr,
                                     take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Calls::
              IAppInitiatedVoipPhoneCallOptions(ptr, take_ownership_from_abi) {}
    AppInitiatedVoipPhoneCallOptions();
    explicit AppInitiatedVoipPhoneCallOptions(
        param::iterable<hstring> const& associatedDeviceIds);
  };
  struct WINRT_IMPL_EMPTY_BASES CallAnswerEventArgs
    ...
    struct WINRT_IMPL_EMPTY_BASES IncomingVoipPhoneCallOptions
        : winrt::Windows::ApplicationModel::Calls::
              IIncomingVoipPhoneCallOptions {
      IncomingVoipPhoneCallOptions(std::nullptr_t) noexcept {}
      IncomingVoipPhoneCallOptions(void* ptr,
                                   take_ownership_from_abi_t) noexcept
          : winrt::Windows::ApplicationModel::Calls::
                IIncomingVoipPhoneCallOptions(ptr, take_ownership_from_abi) {}
      IncomingVoipPhoneCallOptions();
      explicit IncomingVoipPhoneCallOptions(
          param::iterable<hstring> const& associatedDeviceIds);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES OutgoingVoipPhoneCallOptions
        : winrt::Windows::ApplicationModel::Calls::
              IOutgoingVoipPhoneCallOptions {
      OutgoingVoipPhoneCallOptions(std::nullptr_t) noexcept {}
      OutgoingVoipPhoneCallOptions(void* ptr,
                                   take_ownership_from_abi_t) noexcept
          : winrt::Windows::ApplicationModel::Calls::
                IOutgoingVoipPhoneCallOptions(ptr, take_ownership_from_abi) {}
      OutgoingVoipPhoneCallOptions();
      explicit OutgoingVoipPhoneCallOptions(
          param::iterable<hstring> const& associatedDeviceIds);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES VoipCallCoordinator
      ...
      static auto IsCallControlDeviceKindSupportedForAssociation(
          winrt::Windows::ApplicationModel::Calls::
              VoipCallControlDeviceKind const& kind);
      static auto GetDeviceSelectorForCallControl();
    };
    struct WINRT_IMPL_EMPTY_BASES VoipPhoneCall
        : winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall,
          impl::require<
              ...
              winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall4> {
      VoipPhoneCall(std::nullptr_t) noexcept {}
      VoipPhoneCall(void* ptr, take_ownership_from_abi_t) noexcept
          : winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall(
                ptr, take_ownership_from_abi) {}
      using winrt::Windows::ApplicationModel::Calls::IVoipPhoneCall::
          NotifyCallActive;
      using impl::consume_t<VoipPhoneCall,
                            winrt::Windows::ApplicationModel::Calls::
                                IVoipPhoneCall4>::NotifyCallActive;
    };
}
#endif
