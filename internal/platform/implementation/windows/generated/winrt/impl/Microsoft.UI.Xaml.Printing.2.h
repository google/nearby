...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Printing {
  struct AddPagesEventHandler : winrt::Windows::Foundation::IUnknown {
    ...
    AddPagesEventHandler(weak_ref<O>&& object, LM&& lambda_or_method);
    template <typename O, typename M>
    AddPagesEventHandler(std::shared_ptr<O>&& object, M method);
    template <typename O, typename LM>
    AddPagesEventHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method);
    auto operator()(
  ...
  struct GetPreviewPageEventHandler : winrt::Windows::Foundation::IUnknown {
    ...
    template <typename O, typename LM>
    GetPreviewPageEventHandler(weak_ref<O>&& object, LM&& lambda_or_method);
    template <typename O, typename M>
    GetPreviewPageEventHandler(std::shared_ptr<O>&& object, M method);
    template <typename O, typename LM>
    GetPreviewPageEventHandler(std::weak_ptr<O>&& object,
                               LM&& lambda_or_method);
    auto operator()(
        winrt::Windows::Foundation::IInspectable const& sender,
  ...
  struct PaginateEventHandler : winrt::Windows::Foundation::IUnknown {
    ...
    template <typename O, typename LM>
    PaginateEventHandler(weak_ref<O>&& object, LM&& lambda_or_method);
    template <typename O, typename M>
    PaginateEventHandler(std::shared_ptr<O>&& object, M method);
    template <typename O, typename LM>
    PaginateEventHandler(std::weak_ptr<O>&& object, LM&& lambda_or_method);
    auto operator()(
        winrt::Windows::Foundation::IInspectable const& sender,
        winrt::Microsoft::UI::Xaml::Printing::PaginateEventArgs const& e) const;
  };
  struct WINRT_IMPL_EMPTY_BASES AddPagesEventArgs
  ...
  struct WINRT_IMPL_EMPTY_BASES GetPreviewPageEventArgs
  ...
  struct WINRT_IMPL_EMPTY_BASES PaginateEventArgs
  ...
  struct WINRT_IMPL_EMPTY_BASES PrintDocument
