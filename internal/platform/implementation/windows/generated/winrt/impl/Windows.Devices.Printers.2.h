...
WINRT_EXPORT namespace winrt::Windows::Devices::Printers
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IppPrintDevice
        : winrt::Windows::Devices::Printers::IIppPrintDevice,
          impl::require<IppPrintDevice,
                        winrt::Windows::Devices::Printers::IIppPrintDevice2,
                        winrt::Windows::Devices::Printers::IIppPrintDevice3,
                        winrt::Windows::Devices::Printers::IIppPrintDevice4,
                        winrt::Windows::Devices::Printers::IIppPrintDevice5> {
      IppPrintDevice(std::nullptr_t) noexcept {}
      IppPrintDevice(void* ptr, take_ownership_from_abi_t) noexcept
          : winrt::Windows::Devices::Printers::IIppPrintDevice(
    ...
    struct WINRT_IMPL_EMPTY_BASES VirtualPrinterInstallationResult
        : winrt::Windows::Devices::Printers::IVirtualPrinterInstallationResult {
      VirtualPrinterInstallationResult(std::nullptr_t) noexcept {}
      VirtualPrinterInstallationResult(void* ptr,
                                       take_ownership_from_abi_t) noexcept
          : winrt::Windows::Devices::Printers::
                IVirtualPrinterInstallationResult(ptr,
                                                  take_ownership_from_abi) {}
    };
    struct VirtualPrinterManager {
      VirtualPrinterManager() = delete;
      static auto InstallVirtualPrinterAsync(
          winrt::Windows::Devices::Printers::
      ...
      static auto InstallVirtualPrinterForAllUsersAsync(
          winrt::Windows::Devices::Printers::
              VirtualPrinterInstallationParameters const& parameters);
      static auto InstallVirtualPrinterForAllUsersAsync(
          winrt::Windows::Devices::Printers::
      ...
      static auto RemoveVirtualPrinterForAllUsersAsync(
          param::hstring const& printerName);
    };
    struct WINRT_IMPL_EMPTY_BASES VirtualPrinterSupportedFormat
        : winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormat {
      VirtualPrinterSupportedFormat(std::nullptr_t) noexcept {}
      VirtualPrinterSupportedFormat(void* ptr,
                                    take_ownership_from_abi_t) noexcept
          : winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormat(
                ptr, take_ownership_from_abi) {}
      VirtualPrinterSupportedFormat(param::hstring const& contentType,
