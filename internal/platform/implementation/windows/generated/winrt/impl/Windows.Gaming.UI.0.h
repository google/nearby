...
namespace winrt::impl
{
    ...
    inline constexpr auto&
        name_v<winrt::Windows::Gaming::UI::GameChatOverlayContract> =
            L"Windows.Gaming.UI.GameChatOverlayContract";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Gaming::UI::GamingUIProviderContract> =
            L"Windows.Gaming.UI.GamingUIProviderContract";
