...
namespace winrt::impl
{
    ...
    template <>
    struct category<winrt::Windows::Management::Update::
    ...
    template <>
    struct category<winrt::Windows::Management::Update::WindowsSoftwareUpdate> {
    ...
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::WindowsSoftwareUpdate> =
            L"Windows.Management.Update.WindowsSoftwareUpdate";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateActionInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateActionInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateActionProgress> =
        L"Windows.Management.Update.WindowsSoftwareUpdateActionProgress";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateActionResultInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateActionResultInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateAppPackageInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateApprovalInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateApprovalInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateExecutionInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateExecutionInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateLocalizationInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateLocalizationInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateOptionalActionInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateOptionalActionInfo";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateOptionalInfo> =
        L"Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateProvider> =
        L"Windows.Management.Update.WindowsSoftwareUpdateProvider";
    template <>
    inline constexpr auto& name_v<
    ...
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   WindowsSoftwareUpdateProviderPayloadFileInfo> =
            L"Windows.Management.Update."
            L"WindowsSoftwareUpdateProviderPayloadFileInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateProviderStatus> =
    ...
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateActionResult> =
        L"Windows.Management.Update.WindowsSoftwareUpdateActionResult";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateActionType> =
        L"Windows.Management.Update.WindowsSoftwareUpdateActionType";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateArchitecture> =
        L"Windows.Management.Update.WindowsSoftwareUpdateArchitecture";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateInstallationType> =
        L"Windows.Management.Update.WindowsSoftwareUpdateInstallationType";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   WindowsSoftwareUpdateProviderRegistrationType> =
            L"Windows.Management.Update."
            L"WindowsSoftwareUpdateProviderRegistrationType";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateProviderTrustState> =
        L"Windows.Management.Update.WindowsSoftwareUpdateProviderTrustState";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateProviderType> =
        L"Windows.Management.Update.WindowsSoftwareUpdateProviderType";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      WindowsSoftwareUpdateRestartReason> =
        L"Windows.Management.Update.WindowsSoftwareUpdateRestartReason";
    ...
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::IWindowsSoftwareUpdate> =
            L"Windows.Management.Update.IWindowsSoftwareUpdate";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateActionInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateActionInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateActionInfoFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateActionInfoFactory";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateActionProgress> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateActionProgress";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateActionResultInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateActionResultInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateAppPackageInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateAppPackageInfo";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateAppPackageInfoFactory> =
            L"Windows.Management.Update."
            L"IWindowsSoftwareUpdateAppPackageInfoFactory";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateApprovalInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateApprovalInfo";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::
            IWindowsSoftwareUpdateApprovalInfoFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateApprovalInfoFactory";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateExecutionInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateExecutionInfo";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::
            IWindowsSoftwareUpdateExecutionInfoFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateExecutionInfoFactory";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateFactory";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateLocalizationInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateLocalizationInfo";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateLocalizationInfoFactory> =
            L"Windows.Management.Update."
            L"IWindowsSoftwareUpdateLocalizationInfoFactory";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::
            IWindowsSoftwareUpdateOptionalActionInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateOptionalActionInfo";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateOptionalActionInfoFactory> =
            L"Windows.Management.Update."
            L"IWindowsSoftwareUpdateOptionalActionInfoFactory";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateOptionalInfo> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateOptionalInfo";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::
            IWindowsSoftwareUpdateOptionalInfoFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateOptionalInfoFactory";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateProvider> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateProvider";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::
            IWindowsSoftwareUpdateProviderActionResult> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateProviderActionResult";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderActionResultFactory> =
            L"Windows.Management.Update."
            L"IWindowsSoftwareUpdateProviderActionResultFactory";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateProviderFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateProviderFactory";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderPayloadFileInfo> =
            L"Windows.Management.Update."
            L"IWindowsSoftwareUpdateProviderPayloadFileInfo";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateProviderStatus> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateProviderStatus";
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderStatusFactory> =
            L"Windows.Management.Update."
            L"IWindowsSoftwareUpdateProviderStatusFactory";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateResult> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateResult";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateResultFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateResultFactory";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateScanResult> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateScanResult";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateScanResultFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateScanResultFactory";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateVersion> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateVersion";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsSoftwareUpdateVersionFactory> =
        L"Windows.Management.Update.IWindowsSoftwareUpdateVersionFactory";
    ...
    template <>
    inline constexpr auto&
        name_v<winrt::Windows::Management::Update::IWindowsUpdateManager2> =
            L"Windows.Management.Update.IWindowsUpdateManager2";
    ...
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsUpdateManagerFactory2> =
        L"Windows.Management.Update.IWindowsUpdateManagerFactory2";
    template <>
    inline constexpr auto& name_v<
        winrt::Windows::Management::Update::IWindowsUpdateManagerScanOptions> =
        L"Windows.Management.Update.IWindowsUpdateManagerScanOptions";
    template <>
    inline constexpr auto& name_v<winrt::Windows::Management::Update::
                                      IWindowsUpdateManagerScanOptionsFactory> =
        L"Windows.Management.Update.IWindowsUpdateManagerScanOptionsFactory";
    ...
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::IWindowsSoftwareUpdate>{
            0xD8F19211,
            0x98FE,
            0x58DD,
            {0xAF, 0x0F, 0x47, 0x05, 0x32, 0xAA, 0x33,
             0x41}};  // D8F19211-98FE-58DD-AF0F-470532AA3341
    template <>
    inline constexpr guid guid_v<
        ...
        0xF704,
        0x5362,
        {0xB6, 0x00, 0xD1, 0x88, 0x08, 0xF3, 0x97,
         0x3E}};  // 2F6723B5-F704-5362-B600-D18808F3973E
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateActionInfoFactory>{
        0x5E83B58E,
        0xD982,
        0x5D93,
        {0xA7, 0xCB, 0xBF, 0x6C, 0x9B, 0x6E, 0xE5,
         0xA6}};  // 5E83B58E-D982-5D93-A7CB-BF6C9B6EE5A6
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateActionProgress>{
        0x17DC15FD,
        0x75F2,
        0x522B,
        {0xB5, 0x55, 0x35, 0x9D, 0xA8, 0xDE, 0x55,
         0x81}};  // 17DC15FD-75F2-522B-B555-359DA8DE5581
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateActionResultInfo>{
        0xBCF26FBA,
        0x98C8,
        0x51CB,
        {0x8B, 0x7E, 0x1E, 0xED, 0xC3, 0xD8, 0x2A,
         0x69}};  // BCF26FBA-98C8-51CB-8B7E-1EEDC3D82A69
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateAppPackageInfo>{
        0xA5BD59F4,
        0xE624,
        0x5552,
        {0x82, 0xF9, 0x26, 0x7A, 0x45, 0x74, 0xA2,
         0x03}};  // A5BD59F4-E624-5552-82F9-267A4574A203
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateAppPackageInfoFactory>{
            0xA8BDA639,
            0xA4F6,
            0x5A4A,
            {0x8A, 0x54, 0x26, 0xC1, 0xC5, 0x08, 0xCD,
             0x0F}};  // A8BDA639-A4F6-5A4A-8A54-26C1C508CD0F
    template <>
    inline constexpr guid guid_v<
        ...
        0x80AF,
        0x5882,
        {0x94, 0x04, 0x25, 0x43, 0x7E, 0xCB, 0x79,
         0x1B}};  // 691E6B9E-80AF-5882-9404-25437ECB791B
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateApprovalInfoFactory>{
        0xAB291C7C,
        0xD29F,
        0x5AC5,
        {0xB4, 0x47, 0x0B, 0xFC, 0xAB, 0xDC, 0x2C,
         0xC3}};  // AB291C7C-D29F-5AC5-B447-0BFCABDC2CC3
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateExecutionInfo>{
        0x091AEA19,
        0x9128,
        0x5F24,
        {0xAF, 0xC1, 0xA6, 0x22, 0x52, 0xDF, 0x55,
         0xC0}};  // 091AEA19-9128-5F24-AFC1-A62252DF55C0
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateExecutionInfoFactory>{
            ...
            0xB9EF,
            0x5583,
            {0x81, 0x35, 0x94, 0xD6, 0x2E, 0xD6, 0x6E,
             0xD4}};  // 88596F7E-B9EF-5583-8135-94D62ED66ED4
    template <>
    inline constexpr guid guid_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateFactory>{
        0x28E7E01B,
        ...
        {0xBB, 0x51, 0xC6, 0x8F, 0x0B, 0x07, 0x1B,
         0xE5}};  // 28E7E01B-4225-52C8-BB51-C68F0B071BE5
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateLocalizationInfo>{
        0xADC2DE4B,
        0x5966,
        0x5F9F,
        {0xAE, 0x07, 0x00, 0xD4, 0xA2, 0x85, 0xD9,
         0x33}};  // ADC2DE4B-5966-5F9F-AE07-00D4A285D933
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateLocalizationInfoFactory>{
            ...
            0xF5BD,
            0x5C8C,
            {0xBD, 0xB7, 0xA4, 0x61, 0x87, 0x37, 0x4A,
             0xFF}};  // 76979B24-F5BD-5C8C-BDB7-A46187374AFF
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateOptionalActionInfo>{
        0x4AC035D0,
        0xE50E,
        0x5CCB,
        {0xBF, 0xD8, 0xA3, 0x03, 0x56, 0x28, 0x91,
         0xD2}};  // 4AC035D0-E50E-5CCB-BFD8-A303562891D2
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateOptionalActionInfoFactory>{
            ...
            0x4791,
            0x51B6,
            {0xB9, 0x88, 0x96, 0x6E, 0xF9, 0x3A, 0x18,
             0x0B}};  // 88D2FCC1-4791-51B6-B988-966EF93A180B
    template <>
    inline constexpr guid guid_v<
        ...
        0x50C4,
        0x5C33,
        {0xA7, 0x51, 0x7A, 0x12, 0x1F, 0x5A, 0xAE,
         0x70}};  // 78084A73-50C4-5C33-A751-7A121F5AAE70
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateOptionalInfoFactory>{
        0xD837DEED,
        0xA5F2,
        0x5C89,
        {0x8B, 0xEB, 0x85, 0x2D, 0x28, 0x97, 0xB2,
         0xEF}};  // D837DEED-A5F2-5C89-8BEB-852D2897B2EF
    template <>
    inline constexpr guid guid_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateProvider>{
        0x20B67F4A,
        0xE28E,
        0x5D20,
        {0x9C, 0x00, 0xBF, 0x24, 0x99, 0x22, 0xEF,
         0xBE}};  // 20B67F4A-E28E-5D20-9C00-BF249922EFBE
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderActionResult>{
            ...
            0x6BB9,
            0x54DE,
            {0xBD, 0xDA, 0x9D, 0xFB, 0x6C, 0xC1, 0x7C,
             0x16}};  // AFD92B50-6BB9-54DE-BDDA-9DFB6CC17C16
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderActionResultFactory>{
            ...
            0x30C9,
            0x59E9,
            {0xB5, 0x3F, 0x88, 0x46, 0xA8, 0x5D, 0x2D,
             0xC6}};  // 0C002684-30C9-59E9-B53F-8846A85D2DC6
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateProviderFactory>{
        0xFC0D5FC4,
        0xE15E,
        0x5116,
        {0xB2, 0xED, 0xDB, 0x0A, 0x64, 0x99, 0x7F,
         0xFA}};  // FC0D5FC4-E15E-5116-B2ED-DB0A64997FFA
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderPayloadFileInfo>{
            ...
            0x1B01,
            0x5367,
            {0xB4, 0xAE, 0x20, 0xDB, 0x8C, 0xAE, 0x1E,
             0x9B}};  // F1DA16DA-1B01-5367-B4AE-20DB8CAE1E9B
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateProviderStatus>{
        0x076741B8,
        0x7A8E,
        0x53B6,
        {0x9F, 0xB7, 0xE2, 0x90, 0xB1, 0x3C, 0x52,
         0xE9}};  // 076741B8-7A8E-53B6-9FB7-E290B13C52E9
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderStatusFactory>{
            ...
            0x7DFD,
            0x55EF,
            {0x9E, 0x3C, 0x18, 0xD1, 0x45, 0x9E, 0x31,
             0x23}};  // D1E1B416-7DFD-55EF-9E3C-18D1459E3123
    template <>
    inline constexpr guid guid_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateResult>{
        0xA6D7ED98,
        0x6212,
        0x5AD3,
        {0xAA, 0x9D, 0x15, 0xE8, 0x3B, 0xB8, 0x5E,
         0xE4}};  // A6D7ED98-6212-5AD3-AA9D-15E83BB85EE4
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateResultFactory>{
        0x512CE0BF,
        0x9977,
        0x5301,
        {0x9B, 0x29, 0x9E, 0x50, 0x42, 0xC8, 0xCF,
         0x7D}};  // 512CE0BF-9977-5301-9B29-9E5042C8CF7D
    template <>
    inline constexpr guid guid_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateScanResult>{
        0x43CA6D96,
        0x3E6D,
        0x56DA,
        {0xA9, 0x03, 0x65, 0xD4, 0xAB, 0x72, 0x92,
         0x99}};  // 43CA6D96-3E6D-56DA-A903-65D4AB729299
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateScanResultFactory>{
        0x21148E4C,
        0xE7CE,
        0x574E,
        {0xBF, 0xA7, 0x69, 0xDC, 0x77, 0x45, 0x7D,
         0x21}};  // 21148E4C-E7CE-574E-BFA7-69DC77457D21
    template <>
    inline constexpr guid guid_v<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateVersion>{
        0x215E22E7,
        0x6D57,
        0x5305,
        {0x9C, 0x79, 0x4E, 0xCD, 0x4A, 0x4D, 0x78,
         0x71}};  // 215E22E7-6D57-5305-9C79-4ECD4A4D7871
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsSoftwareUpdateVersionFactory>{
        0x650ED994,
        0x0858,
        0x5528,
        {0xA1, 0xF2, 0xF7, 0x3C, 0xA6, 0x4D, 0xAB,
         0xC9}};  // 650ED994-0858-5528-A1F2-F73CA64DABC9
    ...
    template <>
    inline constexpr guid
        guid_v<winrt::Windows::Management::Update::IWindowsUpdateManager2>{
            0x564E7683,
            0xBD21,
            0x57A4,
            {0xB1, 0x7F, 0x7B, 0xF6, 0x35, 0x0F, 0x4C,
             0x75}};  // 564E7683-BD21-57A4-B17F-7BF6350F4C75
    ...
    inline constexpr guid guid_v<
        ...
        0xD160,
        0x59B9,
        {0x98, 0x98, 0x97, 0xA1, 0x86, 0xAD, 0x52,
         0xEA}};  // BA08D663-D160-59B9-9898-97A186AD52EA
    template <>
    inline constexpr guid guid_v<
        winrt::Windows::Management::Update::IWindowsUpdateManagerScanOptions>{
        0xB7C30113,
        0x5E4B,
        0x59D8,
        {0x99, 0xAD, 0xF5, 0x8D, 0x67, 0xB2, 0xAE,
         0xFC}};  // B7C30113-5E4B-59D8-99AD-F58D67B2AEFC
    template <>
    inline constexpr guid guid_v<winrt::Windows::Management::Update::
                                     IWindowsUpdateManagerScanOptionsFactory>{
        0x1A0F9198,
        0xF18D,
        0x5CFD,
        {0x8C, 0xB9, 0x08, 0xF3, 0xFB, 0x74, 0xDA,
         0x70}};  // 1A0F9198-F18D-5CFD-8CB9-08F3FB74DA70
    ...
    struct default_interface<
      ...
      using type = winrt::Windows::Management::Update::IWindowsSoftwareUpdate;
    };
    template <>
    struct default_interface<
        winrt::Windows::Management::Update::WindowsSoftwareUpdateActionInfo> {
    ...
    template <>
    struct default_interface<winrt::Windows::Management::Update::
                                 WindowsSoftwareUpdateActionProgress> {
      using type = winrt::Windows::Management::Update::
          IWindowsSoftwareUpdateActionProgress;
    };
    template <>
    struct default_interface<winrt::Windows::Management::Update::
    ...
    template <>
    struct abi<winrt::Windows::Management::Update::IWindowsSoftwareUpdate> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        ...
        virtual int32_t __stdcall get_DownloadSizeInBytes(
            uint64_t*) noexcept = 0;
        virtual int32_t __stdcall get_InstallSizeInBytes(
            uint64_t*) noexcept = 0;
        ...
        virtual int32_t __stdcall ApproveCurrentAction(bool,
                                                       void**) noexcept = 0;
        ...
        virtual int32_t __stdcall get_AttentionRequiredInfo(
            void**) noexcept = 0;
    ...
    template <>
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateActionInfoFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
    ...
    struct abi<winrt::Windows::Management::Update::
      ...
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall get_PackageFamilyName(void**) noexcept = 0;
        virtual int32_t __stdcall get_PackageArchitecture(
            int32_t*) noexcept = 0;
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateAppPackageInfoFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(void*, int32_t, void*,
                                                 void**) noexcept = 0;
      };
    };
    template <>
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateApprovalInfoFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(bool, bool, bool, bool,
                                                 void**) noexcept = 0;
      };
    };
    template <>
    ...
    struct abi<
        winrt::Windows::Management::Update::IWindowsSoftwareUpdateFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(void*, int32_t, void*, void*,
                                                 void*, void*, uint64_t,
                                                 uint64_t, void*, void*, void*,
                                                 void*, void*,
                                                 void**) noexcept = 0;
        virtual int32_t __stdcall CreateInstance2(void*, int32_t, void*, void*,
                                                  void*, void*, uint64_t,
                                                  uint64_t, void*, void*, void*,
                                                  void*, void*, void*, void*,
                                                  void**) noexcept = 0;
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateLocalizationInfoFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(uint32_t, void*, void*, void*,
                                                 void**) noexcept = 0;
      };
    };
    template <>
    ...
    struct abi<winrt::Windows::Management::Update::
      ...
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        ...
        virtual int32_t __stdcall get_ComplianceDeadlineInDays(
            void**) noexcept = 0;
        virtual int32_t __stdcall get_ComplianceGracePeriodInDays(
            void**) noexcept = 0;
      };
    };
    template <>
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderActionResultFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(int32_t, int32_t, uint32_t,
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateProviderStatus> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall add_CancelRequested(
            void*, winrt::event_token*) noexcept = 0;
        virtual int32_t __stdcall remove_CancelRequested(
            winrt::event_token) noexcept = 0;
        virtual int32_t __stdcall SetScanResult(bool, uint32_t, uint64_t, void*,
                                                void**) noexcept = 0;
        virtual int32_t __stdcall SetActionProgress(uint64_t, uint64_t,
                                                    void**) noexcept = 0;
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateResultFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(bool, uint32_t,
                                                 void**) noexcept = 0;
        virtual int32_t __stdcall CreateInstance2(bool, uint32_t, uint64_t,
                                                  void**) noexcept = 0;
        virtual int32_t __stdcall CreateInstance3(bool, bool, uint32_t,
                                                  uint64_t,
                                                  void**) noexcept = 0;
      };
    };
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateScanResultFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(bool, uint32_t, void*,
                                                 void**) noexcept = 0;
        virtual int32_t __stdcall CreateInstance2(bool, uint32_t, uint64_t,
    ...
    struct abi<winrt::Windows::Management::Update::
                   IWindowsSoftwareUpdateVersionFactory> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(uint32_t, uint32_t, uint32_t,
    ...
    template <>
    struct abi<winrt::Windows::Management::Update::IWindowsUpdateManager2> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall GetProvider(void*, void**) noexcept = 0;
        virtual int32_t __stdcall get_ProviderIds(uint32_t* __valueSize,
                                                  void***) noexcept = 0;
        virtual int32_t __stdcall GetApplicableSoftwareUpdates(
            void**) noexcept = 0;
    ...
    struct abi<
        winrt::Windows::Management::Update::IWindowsUpdateManagerFactory2> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall CreateInstance(void*, uint32_t, void**,
                                                 void**) noexcept = 0;
      };
    };
    template <>
    ...
    template <>
    struct consume<winrt::Windows::Management::Update::IWindowsSoftwareUpdate> {
      template <typename D>
      using type = consume_Windows_Management_Update_IWindowsSoftwareUpdate<D>;
    };
    template <typename D>
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateActionInfo<D>;
    };
    template <typename D>
    struct
      ...
      auto CreateInstance(
          ...
          winrt::Windows::Management::Update::
              WindowsSoftwareUpdateActionType const& actionType) const;
    };
    template <>
    struct consume<winrt::Windows::Management::Update::
                       IWindowsSoftwareUpdateActionInfoFactory> {
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateActionInfoFactory<
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateActionProgress {
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateAppPackageInfo {
      [[nodiscard]] auto PackageFamilyName() const;
    ...
    struct
      ...
      auto CreateInstance(
          ...
          winrt::Windows::Foundation::Uri const& installUri) const;
    };
    template <>
    struct consume<winrt::Windows::Management::Update::
                       IWindowsSoftwareUpdateAppPackageInfoFactory> {
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateApprovalInfo {
    ...
    struct
      ...
      auto CreateInstance(bool userInitiated, bool appClosure,
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateExecutionInfo {
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateFactory<D>;
    };
    template <typename D>
    struct
    ...
    struct
      ...
      auto CreateInstance(
          ...
          param::hstring const& description,
          winrt::Windows::Foundation::Uri const& moreInfoUrl) const;
    };
    template <>
    struct consume<winrt::Windows::Management::Update::
                       IWindowsSoftwareUpdateLocalizationInfoFactory> {
    ...
    struct
      ...
      auto CreateInstance(
          ...
          winrt::Windows::Management::Update::
              WindowsSoftwareUpdateActionInfo const& closeAndRestartInfo) const;
    };
    template <>
    struct consume<winrt::Windows::Management::Update::
                       IWindowsSoftwareUpdateOptionalActionInfoFactory> {
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateOptionalInfo {
    ...
    struct
      ...
      auto CreateInstance(winrt::Windows::Foundation::IReference<int32_t> const&
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateProvider<D>;
    };
    template <typename D>
    struct
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateProviderStatus {
      auto CancelRequested(
          winrt::Windows::Foundation::TypedEventHandler<
              winrt::Windows::Management::Update::
                  WindowsSoftwareUpdateProviderStatus,
              winrt::Windows::Foundation::IInspectable> const& handler) const;
      using CancelRequested_revoker = impl::event_revoker<
          winrt::Windows::Management::Update::
              IWindowsSoftwareUpdateProviderStatus,
          &impl::abi_t<winrt::Windows::Management::Update::
                           IWindowsSoftwareUpdateProviderStatus>::
              remove_CancelRequested>;
      [[nodiscard]] auto CancelRequested(
          auto_revoke_t,
          winrt::Windows::Foundation::TypedEventHandler<
              winrt::Windows::Management::Update::
                  WindowsSoftwareUpdateProviderStatus,
      ...
      auto SetActionResult(winrt::Windows::Management::Update::
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateResult<D>;
    };
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateResultFactory {
      auto CreateInstance(bool succeeded, uint32_t resultCode) const;
      auto CreateInstance2(bool succeeded, uint32_t resultCode,
                           uint64_t extendedError) const;
      auto CreateInstance3(bool succeeded, bool cancelRequested,
                           uint32_t resultCode, uint64_t extendedError) const;
    };
    template <>
    struct consume<winrt::Windows::Management::Update::
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateScanResult<D>;
    };
    template <typename D>
    struct
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsSoftwareUpdateVersion<D>;
    };
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsSoftwareUpdateVersionFactory {
      auto CreateInstance(uint32_t major, uint32_t minor,
                          uint32_t revisionMajor, uint32_t revisionMinor) const;
    };
    template <>
    struct consume<winrt::Windows::Management::Update::
                       IWindowsSoftwareUpdateVersionFactory> {
    ...
    template <>
    struct consume<winrt::Windows::Management::Update::IWindowsUpdateManager2> {
      template <typename D>
      using type = consume_Windows_Management_Update_IWindowsUpdateManager2<D>;
    };
    template <typename D>
    ...
    struct consume_Windows_Management_Update_IWindowsUpdateManagerFactory2 {
      auto CreateInstance(param::hstring const& clientId,
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsUpdateManagerFactory2<D>;
    };
    template <typename D>
    ...
    struct consume<
      ...
      template <typename D>
      using type =
          consume_Windows_Management_Update_IWindowsUpdateManagerScanOptions<D>;
    };
    template <typename D>
    struct
    ...
    template <typename D>
    struct
        consume_Windows_Management_Update_IWindowsUpdateProgressChangedEventArgs {
      [[nodiscard]] auto Update() const;
      [[nodiscard]] auto ActionProgress() const;
    };
