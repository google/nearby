...
namespace winrt::impl
{
    ...
    inline constexpr auto&
        name_v<winrt::Windows::Graphics::Printing::Workflow::
            ...
            L"PrintWorkflowPrinterJobStatusChangedEventArgs";
    ...
    inline constexpr auto& name_v<winrt::Windows::Graphics::Printing::Workflow::
                                      PrintWorkflowXpsObjectModelProvider> =
        L"Windows.Graphics.Printing.Workflow."
        L"PrintWorkflowXpsObjectModelProvider";
    ...
    inline constexpr auto& name_v<winrt::Windows::Graphics::Printing::Workflow::
                                      IPrintWorkflowJobBackgroundSession3> =
        L"Windows.Graphics.Printing.Workflow."
        L"IPrintWorkflowJobBackgroundSession3";
    ...
    inline constexpr auto& name_v<winrt::Windows::Graphics::Printing::Workflow::
                                      IPrintWorkflowObjectModelProvider> =
        L"Windows.Graphics.Printing.Workflow.IPrintWorkflowObjectModelProvider";
    ...
    inline constexpr auto& name_v<winrt::Windows::Graphics::Printing::Workflow::
                                      IPrintWorkflowPdlConverter3> =
        L"Windows.Graphics.Printing.Workflow.IPrintWorkflowPdlConverter3";
    ...
    inline constexpr auto&
        name_v<winrt::Windows::Graphics::Printing::Workflow::
                   IPrintWorkflowPdlModificationRequestedEventArgs3> =
            L"Windows.Graphics.Printing.Workflow."
            L"IPrintWorkflowPdlModificationRequestedEventArgs3";
    ...
    inline constexpr auto&
        name_v<winrt::Windows::Graphics::Printing::Workflow::
                   IPrintWorkflowPrinterJobStatusChangedEventArgs> =
            L"Windows.Graphics.Printing.Workflow."
            L"IPrintWorkflowPrinterJobStatusChangedEventArgs";
    ...
    inline constexpr auto& name_v<winrt::Windows::Graphics::Printing::Workflow::
                                      IPrintWorkflowXpsObjectModelProvider> =
        L"Windows.Graphics.Printing.Workflow."
        L"IPrintWorkflowXpsObjectModelProvider";
    ...
    inline constexpr guid guid_v<winrt::Windows::Graphics::Printing::Workflow::
        ...
        0xEDCC,
        0x5A94,
        {0x90, 0xEC, 0xA0, 0xA8, 0x7C, 0x11, 0x15,
         0xE7}};  // 5757086C-EDCC-5A94-90EC-A0A87C1115E7
    ...
    inline constexpr guid guid_v<winrt::Windows::Graphics::Printing::Workflow::
        ...
        0x6A2D,
        0x489B,
        {0xBC, 0x1F, 0x7A, 0xAB, 0x44, 0x24, 0x96,
         0x22}};  // E3A9F883-6A2D-489B-BC1F-7AAB44249622
    ...
    inline constexpr guid guid_v<winrt::Windows::Graphics::Printing::Workflow::
        ...
        0x3756,
        0x5DA6,
        {0xB1, 0xF7, 0x8F, 0x9E, 0x89, 0xF6, 0x29,
         0xFB}};  // 6B556B4F-3756-5DA6-B1F7-8F9E89F629FB
    ...
    inline constexpr guid
        guid_v<winrt::Windows::Graphics::Printing::Workflow::
            ...
            0xDB49,
            0x5D3E,
            {0xBA, 0x27, 0xB3, 0x66, 0xCB, 0x25, 0xCD,
             0x7E}};  // 1F50A7D4-DB49-5D3E-BA27-B366CB25CD7E
    ...
    inline constexpr guid
        guid_v<winrt::Windows::Graphics::Printing::Workflow::
            ...
            0xBE67,
            0x5718,
            {0x92, 0x1A, 0x34, 0x8C, 0x56, 0xF9, 0xD2,
             0x5F}};  // 4A6275B9-BE67-5718-921A-348C56F9D25F
    ...
    inline constexpr guid guid_v<winrt::Windows::Graphics::Printing::Workflow::
        ...
        0x96D7,
        0x56CC,
        {0xB6, 0x60, 0xA7, 0x14, 0x95, 0x63, 0x2C,
         0xEB}};  // 97D8C1AD-96D7-56CC-B660-A71495632CEB
    ...
    struct abi<winrt::Windows::Graphics::Printing::Workflow::
                   IPrintWorkflowJobBackgroundSession3> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall add_JobStatusChanged(
            void*, winrt::event_token*) noexcept = 0;
        virtual int32_t __stdcall remove_JobStatusChanged(
    ...
    struct abi<winrt::Windows::Graphics::Printing::Workflow::
                   IPrintWorkflowPdlConverter3> {
      struct WINRT_IMPL_NOVTABLE type : inspectable_abi {
        virtual int32_t __stdcall ConvertPdlFromObjectModelAsync(
    ...
    struct
      ...
      auto JobStatusChanged(
          winrt::Windows::Foundation::TypedEventHandler<
              winrt::Windows::Graphics::Printing::Workflow::
                  PrintWorkflowJobBackgroundSession,
              winrt::Windows::Graphics::Printing::Workflow::
                  PrintWorkflowPrinterJobStatusChangedEventArgs> const& handler)
          const;
      using JobStatusChanged_revoker = impl::event_revoker<
          winrt::Windows::Graphics::Printing::Workflow::
              IPrintWorkflowJobBackgroundSession3,
          &impl::abi_t<winrt::Windows::Graphics::Printing::Workflow::
                           IPrintWorkflowJobBackgroundSession3>::
              remove_JobStatusChanged>;
      [[nodiscard]] auto JobStatusChanged(
          auto_revoke_t,
          winrt::Windows::Foundation::TypedEventHandler<
              winrt::Windows::Graphics::Printing::Workflow::
                  PrintWorkflowJobBackgroundSession,
    ...
    template <typename D>
    struct
        consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowJobIssueDetectedEventArgs {
    ...
    template <typename D>
    struct
        consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowObjectModelProvider {
    };
    template <>
    struct consume<winrt::Windows::Graphics::Printing::Workflow::
                       IPrintWorkflowObjectModelProvider> {
    ...
    template <typename D>
    struct
        consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlConverter3 {
    ...
    template <typename D>
    struct
        consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlDataAvailableEventArgs {
      [[nodiscard]] auto Configuration() const;
      [[nodiscard]] auto PrinterJob() const;
    ...
    template <typename D>
    struct
        consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlSourceContent {
    ...
    template <typename D>
    struct
        consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowXpsObjectModelProvider {
    };
    template <>
    struct consume<winrt::Windows::Graphics::Printing::Workflow::
                       IPrintWorkflowXpsObjectModelProvider> {
