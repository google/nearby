...
template <typename D>
auto consume_Microsoft_Windows_SemanticSearch_IEmbeddingVector<D>::GetValues(
    array_view<float> values) const {
  if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::SemanticSearch::
                                       IEmbeddingVector>) {
    winrt::hresult _winrt_cast_result_code;
    auto const _winrt_casted_result = impl::try_as_with_reason<
        winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVector, D const*>(
        static_cast<D const*>(this), _winrt_cast_result_code);
    check_hresult(_winrt_cast_result_code);
    auto const _winrt_abi_type =
        *(abi_t<winrt::Microsoft::Windows::SemanticSearch::
                    IEmbeddingVector>**)&_winrt_casted_result;
    check_hresult(_winrt_abi_type->GetValues(values.size(), put_abi(values)));
  } else {
    auto const _winrt_abi_type =
        *(abi_t<
            winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVector>**)this;
    check_hresult(_winrt_abi_type->GetValues(values.size(), put_abi(values)));
  }
}
template <typename D>
auto consume_Microsoft_Windows_SemanticSearch_IEmbeddingVector<D>::Count()
    const {
  uint32_t value{};
  if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::SemanticSearch::
                                       IEmbeddingVector>) {
...
template <typename D>
auto consume_Microsoft_Windows_SemanticSearch_IEmbeddingVector<
...
template <typename D>
auto consume_Microsoft_Windows_SemanticSearch_IEmbeddingVectorFactory<
  ...
  return winrt::Microsoft::Windows::SemanticSearch::EmbeddingVector{
      value, take_ownership_from_abi};
}
#ifndef WINRT_LEAN_AND_MEAN
template <typename D>
struct produce<D, winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVector>
    : produce_base<
          D, winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVector> {
...
template <typename D>
struct produce<
    D, winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVectorFactory>
    : produce_base<
          D,
          winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVectorFactory> {
  int32_t __stdcall CreateInstance(uint32_t __dataSize, float* data,
    ...
    typename D::abi_guard guard(this->shim());
    *value =
        detach_from<winrt::Microsoft::Windows::SemanticSearch::EmbeddingVector>(
...
#ifndef WINRT_LEAN_AND_MEAN
template <>
struct hash<winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVector>
    : winrt::impl::hash_base {};
template <>
struct hash<winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVectorFactory>
    : winrt::impl::hash_base {};
template <>
struct hash<winrt::Microsoft::Windows::SemanticSearch::EmbeddingVector>
    : winrt::impl::hash_base {};
#endif
