...
namespace winrt::impl
{
    ...
    {
        int32_t value{};
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::Devices::Power::IBattery>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::Phone::Devices::Power::IBattery, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::Devices::Power::IBattery>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_RemainingChargePercent(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::Devices::Power::IBattery>**)this;
            check_hresult(_winrt_abi_type->get_RemainingChargePercent(&value));
        }
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Phone_Devices_Power_IBattery<D>::RemainingChargePercentChanged(winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& changeHandler) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::Devices::Power::IBattery>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::Devices::Power::IBattery>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->add_RemainingChargePercentChanged(*(void**)(&changeHandler), put_abi(token)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::Devices::Power::IBattery>**)this;
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::Devices::Power::IBatteryStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::Phone::Devices::Power::IBatteryStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::Devices::Power::IBatteryStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetDefault(&result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::Devices::Power::IBatteryStatics>**)this;
            check_hresult(_winrt_abi_type->GetDefault(&result));
        }
