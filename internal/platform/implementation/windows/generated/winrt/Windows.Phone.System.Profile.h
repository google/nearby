...
namespace winrt::impl
{
    ...
    {
        bool value{};
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::System::Profile::IRetailModeStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::Phone::System::Profile::IRetailModeStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::System::Profile::IRetailModeStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_RetailModeEnabled(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::System::Profile::IRetailModeStatics>**)this;
            check_hresult(_winrt_abi_type->get_RetailModeEnabled(&value));
        }
        return value;
    }
