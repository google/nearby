...
namespace winrt::impl
{
    ...
    {
        bool value{};
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IBackPressedEventArgs>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_Handled(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IBackPressedEventArgs>**)this;
            check_hresult(_winrt_abi_type->get_Handled(&value));
        }
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics<D>::BackPressed(winrt::Windows::Foundation::EventHandler<winrt::Windows::Phone::UI::Input::BackPressedEventArgs> const& handler) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->add_BackPressed(*(void**)(&handler), put_abi(token)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>**)this;
            check_hresult(_winrt_abi_type->add_BackPressed(*(void**)(&handler), put_abi(token)));
        }
        return token;
    }
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics<D>::BackPressed(winrt::event_token const& token) const noexcept
    {
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>**)&_winrt_casted_result;
            _winrt_abi_type->remove_BackPressed(impl::bind_in(token));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics>**)this;
    ...
    {
        winrt::event_token token{};
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->add_CameraHalfPressed(*(void**)(&handler), put_abi(token)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)this;
            check_hresult(_winrt_abi_type->add_CameraHalfPressed(*(void**)(&handler), put_abi(token)));
        }
        return token;
    }
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics2<D>::CameraHalfPressed(winrt::event_token const& token) const noexcept
    {
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)&_winrt_casted_result;
            _winrt_abi_type->remove_CameraHalfPressed(impl::bind_in(token));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)this;
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics2<D>::CameraPressed(winrt::Windows::Foundation::EventHandler<winrt::Windows::Phone::UI::Input::CameraEventArgs> const& handler) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->add_CameraPressed(*(void**)(&handler), put_abi(token)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)this;
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics2<D>::CameraPressed(winrt::event_token const& token) const noexcept
    {
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)&_winrt_casted_result;
            _winrt_abi_type->remove_CameraPressed(impl::bind_in(token));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)this;
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics2<D>::CameraReleased(winrt::Windows::Foundation::EventHandler<winrt::Windows::Phone::UI::Input::CameraEventArgs> const& handler) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->add_CameraReleased(*(void**)(&handler), put_abi(token)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)this;
    ...
    template <typename D> auto consume_Windows_Phone_UI_Input_IHardwareButtonsStatics2<D>::CameraReleased(winrt::event_token const& token) const noexcept
    {
        if constexpr (!std::is_same_v<D, winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)&_winrt_casted_result;
            _winrt_abi_type->remove_CameraReleased(impl::bind_in(token));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::Phone::UI::Input::IHardwareButtonsStatics2>**)this;
