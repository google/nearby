...
using api::ble_v2::ServerGattConnectionCallback;

// This class is used to advertise a GATT service.
// https://learn.microsoft.com/en-us/uwp/api/windows.devices.bluetooth.genericattributeprofile.gattserviceprovider?view=winrt-22621
...
class GattServer : public api::ble_v2::GattServer {
 public:
  explicit GattServer(ServerGattConnectionCallback server_callback);
  ...
  GattServiceProvider GetServiceProvider() { return service_provider_; }

  void HandleAdvertisementStatusChanged(
 ...
 private:
  ...
  ::nearby::ByteArray value_;
  ServerGattConnectionCallback server_callback_;
};
