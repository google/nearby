...
// been called.
// The name returned here is irrelevant. It is here to satisfy the interface. It
// is only used to backup and restore device name when BT is made discoverable.
// Since Windows never makes BT discoverable, this has no effect.
