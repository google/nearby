...
class WifiHotspotMedium : public api::WifiHotspotMedium {
 ...
 private:
  ...
  static const int MEDIUM_STATUS_BEACONING = (1 << 1);
  static const int MEDIUM_STATUS_CONNECTED = (1 << 2);
  ...
  bool IsBeaconing() { return (medium_status_ & MEDIUM_STATUS_BEACONING) != 0; }
  // Discoverer is connected with the Hotspot
  bool IsConnected() { return (medium_status_ & MEDIUM_STATUS_CONNECTED) != 0; }
