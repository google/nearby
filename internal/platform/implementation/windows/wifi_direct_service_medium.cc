...
bool WifiDirectServiceMedium::StartWifiDirectService() {
  ...
  winrt::hstring const& service_name = {L"QuickShare"};
  advertiser_ = WiFiDirectServiceAdvertiser(service_name);
...
fire_and_forget WifiDirectServiceMedium::OnAdvertisementStatusChanged(
  ...
  LOG(INFO) << "WifiDirectServiceMedium::OnAdvertisementStatusChanged status: "
            << (int)status;
  switch (status) {
    case WiFiDirectServiceStatus ::Available:
      LOG(INFO) << "WifiDirectServiceMedium::OnAdvertisementStatusChanged "
                   "status: Available";
      break;
...
fire_and_forget WifiDirectServiceMedium::OnSessionRequested(
  ...
  LOG(INFO) << "WifiDirectServiceMedium::OnSessionRequested";
  try {
...
bool WifiDirectServiceMedium::ConnectWifiDirectService() {
  ...
  winrt::hstring const& service_name = {L"QuickShare"};
  winrt::hstring device_selector = WiFiDirectService::GetSelector(service_name);
