...
#ifndef PLATFORM_IMPL_WINDOWS_BLE_SERVER_SOCKET_H_
#define PLATFORM_IMPL_WINDOWS_BLE_SERVER_SOCKET_H_
...
class BleV2ServerSocket : public api::ble_v2::BleServerSocket {
 public:
  explicit BleV2ServerSocket(absl::string_view service_name);
