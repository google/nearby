...
#ifndef PLATFORM_IMPL_WINDOWS_BLE_SOCKET_H_
#define PLATFORM_IMPL_WINDOWS_BLE_SOCKET_H_
...
class BleV2Socket : public ::nearby::api::ble_v2::BleSocket {
 public:
  ...
  explicit BleV2Socket(StreamSocket streamSocket);
 ...
 private:
  ...
  std::unique_ptr<BleV2Peripheral> bluetooth_device_ = nullptr;
};
