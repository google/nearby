  ...
  absl::AnyInvocable<void()> close_notifier = nullptr;
  {
    ...
    if (gatt_service_provider_ != nullptr) {
      try {
        ...
        if (service_provider_advertisement_changed_token_.value != 0) {
