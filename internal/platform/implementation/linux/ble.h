...
#ifndef PLATFORM_IMPL_LINUX_BLE_H_
#define PLATFORM_IMPL_LINUX_BLE_H_
...
public:
  ...
  bool
  StartAdvertising(const std::string &service_id,
  ...
  Connect(api::BlePeripheral &remote_peripheral, const std::string &service_id,
...
#endif // PLATFORM_IMPL_LINUX_BLE_H_
