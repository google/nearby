...
class CredentialStorage {
 public:
  ...
  virtual std::vector<::nearby::internal::PrivateCredential>
  GetPrivateCredentialsForTesting(
      const std::tuple<absl::string_view, absl::string_view>& key) = 0;
  virtual std::vector<::nearby::internal::PublicCredential>
  GetPublicCredentialsForTesting(
      const std::tuple<absl::string_view, absl::string_view,
                       api::PublicCredentialType>& key) = 0;
};
