...
#ifndef THIRD_PARTY_NEARBY_FASTPAIR_TESTING_FAKE_CONTEXT_H_
#define THIRD_PARTY_NEARBY_FASTPAIR_TESTING_FAKE_CONTEXT_H_
...
#endif  // THIRD_PARTY_NEARBY_FASTPAIR_TESTING_FAKE_CONTEXT_H_
