...
void StartDiscoveryDart(Core* pCore, const char* service_id,
  ...
  location::nearby::windows::DiscoveryListenerFP listener;
  listener.endpoint_found_cb = location::nearby::windows::make_callback(
      [listener_dart](const char* endpoint_id, const ByteArray& endpoint_info,
        ...
        dart_object_endpoint_id.value.as_string = (char*)endpoint_id;
  ...
  listener.endpoint_lost_cb = location::nearby::windows::make_callback(
      [listener_dart](const char* endpoint_id) {
        NEARBY_LOG(INFO, "Device lost: id=%s", endpoint_id);
        Dart_CObject dart_object_lost;
        dart_object_lost.type = Dart_CObject_kString;
        dart_object_lost.value.as_string = (char*)endpoint_id;
        const bool result =
  ...
  listener.endpoint_distance_changed_cb =
      location::nearby::windows::make_callback(
          [listener_dart](const char* endpoint_id, DistanceInfo info) {
            ...
            dart_object_distance_changed.value.as_string = (char*)endpoint_id;
            const bool result =
                Dart_PostCObject_DL(listener_dart.distance_changed_cb,
  ...
  ResultCallback callback;
  SetResultCallback(callback, result_cb);
  StartDiscovery(pCore, service_id, options, std::move(listener), callback);
}
...
void AcceptConnectionDart(Core* pCore, const char* endpoint_id,
  ...
  location::nearby::windows::PayloadListenerFP listener;
  listener.payload_cb = location::nearby::windows::make_callback(
      [listener_dart](const char* endpoint_id, Payload& payload) {
        // TODO: pass payload in callback
        Dart_CObject dart_object_payload;
        dart_object_payload.type = Dart_CObject_kString;
        dart_object_payload.value.as_string = (char*)endpoint_id;
        const bool result =
  ...
  listener.payload_progress_cb = location::nearby::windows::make_callback(
      [listener_dart](const char* endpoint_id,
  ...
  ResultCallback callback;
  SetResultCallback(callback, result_cb);
  AcceptConnection(pCore, endpoint_id, std::move(listener), callback);
}
