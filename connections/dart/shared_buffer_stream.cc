...
nearby::ExceptionOr<nearby::ByteArray> SharedBufferStream::Read(
  ...
  if (shared_buffer_->readPosition >= shared_buffer_->writePosition) {
    LOG(INFO) << "Reading shared_buffer_->dataAvailable set as false";
