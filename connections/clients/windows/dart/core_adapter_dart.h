...
enum PayloadType {
  ...
  STREAM,
  FILE,
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/payload.dart)
};
...
struct Mediums {
  ...
  int64_t web_rtc;
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/mediums.dart)
};
...
struct AdvertisingOptionsDart {
  ...
  Mediums mediums;
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/advertising_options.dart)
};
...
struct ConnectionOptionsDart {
  ...
  Mediums mediums;
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/connection_options.dart)
};
...
struct DiscoveryOptionsDart {
  ...
  Mediums mediums;
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/discovery_options.dart)
};
...
struct DiscoveryListenerDart {
  ...
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/discovery_listener.dart)
};
...
struct PayloadListenerDart {
  ...
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/payload_listener.dart)
};
...
struct ConnectionListenerDart {
  ...
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/connection_listener.dart)
};
...
struct ConnectionRequestInfoDart {
  ...
  // LINT.ThenChange(//depot/google3/location/nearby/apps/helloconnections/plugins/nearby_connections/platform/lib/connection_request_info.dart)
};
