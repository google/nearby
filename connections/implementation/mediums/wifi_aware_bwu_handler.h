...
#ifndef CORE_INTERNAL_MEDIUMS_WIFI_AWARE_BWU_HANDLER_H_
#define CORE_INTERNAL_MEDIUMS_WIFI_AWARE_BWU_HANDLER_H_
...
class WifiAwareBwuHandler : public BaseBwuHandler {
 public:
  explicit WifiAwareBwuHandler(
      Mediums& mediums,
 ...
 private:
  ...
  Mediums& mediums_;
  WifiAware& wifi_aware_medium_{mediums_.GetWifiAware()};
};

}  // namespace connections
}  // namespace nearby

#endif  // CORE_INTERNAL_MEDIUMS_WIFI_AWARE_BWU_HANDLER_H_
