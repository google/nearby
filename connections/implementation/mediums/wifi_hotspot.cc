...
// Start WifiHotspot: Call the Medium to start a softAP and send beacon for
// Client to scan and connect
...
HotspotCredentials* WifiHotspot::GetCredentials(const std::string& service_id) {
  MutexLock lock(&mutex_);
