...
#ifndef CORE_INTERNAL_WIFI_AWARE_ENDPOINT_CHANNEL_H_
#define CORE_INTERNAL_WIFI_AWARE_ENDPOINT_CHANNEL_H_
...
#endif  // CORE_INTERNAL_WIFI_AWARE_ENDPOINT_CHANNEL_H_
