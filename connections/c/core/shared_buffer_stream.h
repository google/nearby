...
#ifndef THIRD_PARTY_NEARBY_CONNECTIONS_C_CORE_SHARED_BUFFER_STREAM_H_
#define THIRD_PARTY_NEARBY_CONNECTIONS_C_CORE_SHARED_BUFFER_STREAM_H_
...
#endif  // THIRD_PARTY_NEARBY_CONNECTIONS_C_CORE_SHARED_BUFFER_STREAM_H_
